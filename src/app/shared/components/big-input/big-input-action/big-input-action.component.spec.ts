...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<st-big-input-action></st-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<st-big-input-action [disabled]="true"></st-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<st-big-input-action fontSet="fas" fontIcon="fa-trash"></st-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<st-big-input-action label="delete"></st-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<st-big-input-action (action)="actionHandler()"></st-big-input-action>';
    fixture = createHostComponent(template);
